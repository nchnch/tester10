    ...
    public class рисунок
    {
        ...
        )
        {
            ...
            for (int i = смещение_первого_бара; i < смещение_первого_бара + количество_баров; i++) //собираем данные для отрисовки
            {
                ...
                // рисуем выходные 
                Pen перо_выходных = new Pen(цвет_выходных,2);
                    ...
                    if (котировки[i-1].time.DayOfWeek == DayOfWeek.Friday)
                        {
                                ...
                                (
                                    перо_выходных,
                                    Convert.ToInt32(точка_два_Х - ширина_бара * 0.25), 
                                    0,
                                   Convert.ToInt32(точка_два_Х - ширина_бара * 0.25),
                                    высота_окна
                                );
                             ...
                             //   (
                                 //   перо_выходных,
                                 //   Convert.ToInt32(точка_один_Х-ширина_бара/0.75),
                                //    0,
                                  //  Convert.ToInt32(точка_два_Х - ширина_бара/0.75),
                                //    высота_окна
                             //   );
                            }
