...
namespace b_библиотека_форм
{
    public class рисунок
    {
        ...
        public Bitmap картинка_копия;
        public Bitmap картинка_копия2;
        Graphics рисовалка;
        Graphics рисовалка_копия;
        double ширина_бара;
        Font шрифт;
        ...
        )
        {
            ...
            // рисовалка.DrawRectangles
            //var картинка_копия = картинка.Clone(); // так нормально 
            картинка_копия = (Bitmap)картинка.Clone();
        ...
        {
            картинка_копия = (Bitmap)картинка.Clone();
            рисовалка_копия.DrawLine(p_кисть_для_выделения, p_старт.X, p_старт.Y, p_старт.X, p_финиш.Y);
            рисовалка_копия.DrawLine(p_кисть_для_выделения, p_финиш.X, p_старт.Y, p_финиш.X, p_финиш.Y);
            рисовалка_копия.DrawLine(p_кисть_для_выделения, p_старт.X, p_финиш.Y, p_финиш.X, p_финиш.Y);
            рисовалка_копия.DrawLine(p_кисть_для_выделения, p_старт.X, p_старт.Y, p_финиш.X, p_старт.Y);
       ...
       public рисунок( int ширина_окна_,int высота_окна_, Color цвет_котировок_, List<Quotes> Q_)
        {
            ...
            картинка_копия = new Bitmap(ширина_окна, высота_окна);
            рисовалка = Graphics.FromImage(картинка);
            рисовалка_копия = Graphics.FromImage(картинка_копия);
