...
// все расчеты вынести отсюда оставить только события и вызов библиотеки расчетов и публикацию картинки
...
namespace b_формы
{
    public class расчеты_для_рисунка
    {
        ...
        b_данные.котировки o_котировки_1 = new b_данные.котировки();
        b_сервер.рисунок o_рисунок_1;
        List<Quotes> l_Q;
        //ToolTip o_подсказка;
        ...
        private void e_кнопка_загрузка_клик(object sender, EventArgs e)// кнопка загрузка нажата
        {
            ...
            o_рисунок_1 = new b_сервер.рисунок(vi_ширина_рисунка, vi_высота_рисунка, vc_цвет_котировок, l_Q);
            fv_рисуем();
        }
